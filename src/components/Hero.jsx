...
const Hero = ({ socials, hero, openEmailClient }) => {
  ...
  return (
    ...
    >
      <motion.h1 className="absolute left-2/4 overflow-hidden -translate-x-2/4 top-12 text-7xl text-center md:text-left md:top-20 md:text-[7rem] lg:top-20 lg:text-9.5xl xl:top-10 xl:text-14xl tracking-tight md:text-nowrap font-semibold">
        <FadeUpTitle word={title} delay={2200} />
        <motion.span
          initial={{ x: 100 }}
          animate={{
            x: 0,
